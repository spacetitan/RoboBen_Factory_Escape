...
[GlobalClass]
public partial class Shrine : EventData
{
...
{
	public GambleMoney(string body, string outcome) : base(body, outcome)
	{
		this.body = body;
	...
	private void SetCost(int cost)
	{
		...
		if (RunManager.instance.currentRun.gold < cost)
		{
